...
bool ** Executive::Combine(int size, bool * Holder[], bool input0[], bool input1[], bool input2[], bool input3[], bool input4[], bool input5[], bool input6[], bool input7[], bool input8[], bool input9[], bool input10[], bool input11[], bool input12[], bool input13[], bool input14[], bool input15[])
{
	for(int i = 0; i<size; i++)
	{
		...
		Holder[i+size*3] = &input3[i];
		Holder[i+size*4] = &input4[i];
		Holder[i+size*5] = &input5[i];
		Holder[i+size*6] = &input6[i];
		Holder[i+size*7] = &input7[i];
		Holder[i+size*8] = &input8[i];
		Holder[i+size*9] = &input9[i];
		Holder[i+size*10] = &input10[i];
		Holder[i+size*11] = &input11[i];
		Holder[i+size*12] = &input12[i];
		Holder[i+size*13] = &input13[i];
		Holder[i+size*14] = &input14[i];
		Holder[i+size*15] = &input15[i];
	}
	return(Holder);
}
bool ** Executive::Combine(int size, bool * Holder[], bool input0[], bool input1[], bool input2[], bool input3[], bool input4[], bool input5[], bool input6[], bool input7[], bool input8[], bool input9[], bool input10[], bool input11[], bool input12[], bool input13[], bool input14[], bool input15[], bool input16[])
{
	for(int i = 0; i<size; i++)
	{
		Holder[i] = &input0[i];
